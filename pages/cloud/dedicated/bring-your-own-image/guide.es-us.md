...
También puede utilizar esta opción al reinstalar el servidor desde el área de cliente de OVHcloud ([consulte la guía "Primeros pasos"](../primeros-pasos-servidor-dedicado/#instalrtm)). Por favor, utilice las siguientes instrucciones como referencia.
